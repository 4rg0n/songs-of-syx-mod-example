...
| RESOURCE_GROOMING.\<RESOURCE\>         | no       | none                  | 0      | 2147483647 | List of resources the race produces when visiting a barber with amounts<br/>Possible \<RESOURCE\> names can be found in `assets/init/resource`.                                                                                                                                                                                 | `{ LEATHER: 2, COTTON: 1, }`                                                                                 |
