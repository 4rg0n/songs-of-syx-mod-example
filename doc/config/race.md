...
| PREFERRED.OTHER_RACES_REVERSE.\<RACE\> | keylist:float | no       | none    | 0.0  | 1.0   | List of races and how they like this one. <br/>Possible \<RACE\> names can be found in `assets/init/race`.                                                                                                                                                                                                                  | `{ DRAKEN: 0.3, }`<br/>or `{ *: 0.5, }` for all                                                |
