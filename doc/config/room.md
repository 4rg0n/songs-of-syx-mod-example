...
| BOOSTING                 | no       | none    | none       | none                                                                                            | A list of booster keys for increasing various things when the admin room is working properly. The boosts will be multiplied.<br/>For possible booster keys see: [all boosters](boosters.md)                           | `[ ROOM_FARM*, ROOM_MINE*, WORLD_WORLD_RESOURCE_PRODUCTION_*, ]` |
| WORK                     | no       | none    | none       | none                                                                                            | See [WORK key](#work-key)                                                                                                                                                                                                 |                                                                  |
| INDUSTRY.IN.\<RESOURCE\> | yes      | none    | 0.0        | 10000.0                                                                                         | Input resource consumed when working.<br/>Possible \<RESOURCE\>s can be found in `assets/init/resource`.<br/>See [INDUSTRY key](#industry-and-industries-keys)                                                            | See [INDUSTRY and INDUSTRIES key](#industry-and-industries-keys) |
...
| TYPE                          | no       | none    | none                                                                                             | none                                                                                            | The only known use case for this is `TORCH`. When a monument is a torch, the game will render light around it.                                                                      | `TORCH` |
